        ...
        <div class="discuss-list">
            ...
            <div class="discuss-box">
                ...
                <div class="ava">
                    ...
                    <img src="{{ asset($topic->user->avatar) }}" alt="{{ $topic->user->name }}" onmouseover="showFloat(this)" onmouseout="hideFloat(this)" onclick="location.href=`{{ route('users.show',$topic->user_id) }}` ">
